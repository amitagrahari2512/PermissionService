...
public class SecurityAccessContext {
	...
	public String toString() {
		...
		message.append("SecurityAccessContext{\n");

		if (subject != null) {
			message.append("subject=" + subject.toString() + "\n");
		}

		if (resource != null) {
			message.append("resource=" + resource.toString() + "\n");
		}

		if (action != null) {
			message.append("action=" + action.toString() + "\n");
		}

		if (environment != null) {
			message.append("environment=" + environment.toString() + "\n");
		}
